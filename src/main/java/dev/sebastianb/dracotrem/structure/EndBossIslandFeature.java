...
public class EndBossIslandFeature extends StructureFeature<DefaultFeatureConfig> {
    public EndBossIslandFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
    ...
    public static class Start extends StructureStart<DefaultFeatureConfig> {
        ...
        public void init(DynamicRegistryManager registryManager, ChunkGenerator chunkGenerator, StructureManager manager, int chunkX,
            ...
            EndBossIslandGenerator.addPieces(manager, pos, rotation, this.children);
