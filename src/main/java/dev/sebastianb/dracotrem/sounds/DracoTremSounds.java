...
public class DracoTremSounds {
    ...
    public static final SoundEvent DRAGON_BOSS_MUSIC = new SoundEvent(new Identifier(MOD_ID,"records/babydragonbossmusic01"));


    public static void register() {
        Registry.register(Registry.SOUND_EVENT, new Identifier(MOD_ID, "dragonegghit_error"), DRAGONEGGHIT_ERROR);
        Registry.register(Registry.SOUND_EVENT, new Identifier(MOD_ID, "records/babydragonbossmusic01"), DRAGON_BOSS_MUSIC);
    }
}
